...
not just `i32` as in our example. This is a great example of the power of traits in Rust.
...
There are still 2 lines in our implementation that still feel 'over-engineered' - or rather, it feels like
